...
, db = mongojs(config.dbConnect, ['bookings']); // Import database*/
...
let manageServer = require("./manage")(app, db);
...
let adminServer = require("./adminServer")(httpServer, manageServer, db);
